...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-uint64.js",
      format: "umd",
      name: "capnpJsUint64",
      sourcemap: true,
      globals: {},
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-uint64.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-uint64.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-uint64.js.map",
            },
          }))
